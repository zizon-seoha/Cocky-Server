...
public record ProblemDetailResponse(
        Long problemId, String title, String content, String language, Difficulty difficulty) {

    public static ProblemDetailResponse from(Problem problem) {
        return new ProblemDetailResponse(problem.getId(), problem.getTitle(), problem.getContent(),
                problem.getLanguage().name(), problem.getDifficulty());
    }
}
